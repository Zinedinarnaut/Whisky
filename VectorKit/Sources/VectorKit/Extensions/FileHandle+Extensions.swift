...
extension FileHandle {
    ...
    func writeApplicaitonInfo() {
        ...
        header += "Vector Version: \(Bundle.main.infoDictionary?["CFBundleShortVersionString"] ?? "")\n"
    ...
    func writeInfo(for bottle: Bottle) {
        ...
        if let version = VectorWineInstaller.vectorWineVersion() {
            header += "VectorWine Version: \(version.major).\(version.minor).\(version.patch)\n"
        }
