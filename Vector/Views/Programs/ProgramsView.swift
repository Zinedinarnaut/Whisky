...
struct ProgramsView: View {
    ...
    var body: some View {
        Form {
            ...
            .animation(.vectorDefault, value: sortedPrograms)
        ...
        .formStyle(.grouped)
        .animation(.vectorDefault, value: sortedPrograms)
        .animation(.vectorDefault, value: bottle.settings.blocklist)
        .animation(.vectorDefault, value: searchText)
        .animation(.vectorDefault, value: areProgramsExpanded)
        .animation(.vectorDefault, value: isBlocklistExpanded)
